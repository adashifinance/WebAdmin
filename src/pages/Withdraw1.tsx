...
import styles from "./Withdraw1.module.css";

const Withdraw1: FunctionComponent = () => {
    ...
    <div className={styles.withdrawDiv}>
      ...
      <div className={styles.frameDiv1}>
        ...
        <div className={styles.passwordInputDiv}>
          ...
          <img
            ...
            alt=""
            src="../vuesaxlineararrowdown19.svg"
          />
        </div>
      </div>
      ...
      <div className={styles.frameDiv2}>
        <div className={styles.emailphoneInputDiv}>
          <div className={styles.amountDiv}>Cards</div>
