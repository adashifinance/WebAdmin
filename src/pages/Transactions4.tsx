...
import styles from "./Transactions4.module.css";

const Transactions4: FunctionComponent = () => {
  ...
  return (
    <div className={styles.transactionsDiv}>
      ...
      <img
        ...
        alt=""
        src="../vuesaxbulkprofile2user2.svg"
      />
      <img
      ...
      <div className={styles.frameDiv1}>
        ...
        <div className={styles.groupDiv}>
          ...
          <img className={styles.groupIcon} alt="" src="../group-644.svg" />
          <div className={styles.withdrawalDiv}>Withdrawal</div>
          <div className={styles.div}>$21,000.50</div>
          <div className={styles.bM234253464EDDiv}>BM234253464ED</div>
          <div className={styles.iWouldLikeToCollect}>
        ...
        <div className={styles.groupDiv}>
          ...
          <img className={styles.groupIcon} alt="" src="../group-645.svg" />
          <div className={styles.withdrawalDiv}>Withdrawal</div>
          <div className={styles.div}>$21,000.50</div>
          <div className={styles.bM234253464EDDiv}>BM234253464ED</div>
          <div className={styles.iWouldLikeToCollect}>
        ...
        <div className={styles.groupDiv}>
          ...
          <img className={styles.groupIcon} alt="" src="../group-647.svg" />
          <div className={styles.withdrawalDiv}>Withdrawal</div>
          <div className={styles.div}>$21,000.50</div>
          <div className={styles.bM234253464EDDiv}>BM234253464ED</div>
          <div className={styles.iWouldLikeToCollect}>
      ...
      <div className={styles.groupDiv19}>
        ...
        <div className={styles.passwordInputDiv}>
          <div className={styles.dateRangeDiv}>Date range</div>
          ...
          <img
            ...
            src="../vuesaxbulkcalendar.svg"
          />
          <div className={styles.endDateDiv}>End date</div>
          <div className={styles.startDateDiv}>Start date</div>
        </div>
        <div className={styles.btnDiv1}>
          <div className={styles.rectangleDiv19} />
          <b className={styles.downloadB1}>Download</b>
        </div>
        <img
        ...
        />
        <div className={styles.downloadTransactionsDiv}>
