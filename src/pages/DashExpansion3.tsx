...
import styles from "./DashExpansion3.module.css";

const DashExpansion3: FunctionComponent = () => {
  ...
  return (
    <div className={styles.dashExpansionDiv}>
      ...
      <img className={styles.vectorIcon1} alt="" src="../vector-43.svg" />
