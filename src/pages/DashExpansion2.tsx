...
import styles from "./DashExpansion2.module.css";

const DashExpansion2: FunctionComponent = () => {
  ...
  return (
    <div className={styles.dashExpansionDiv}>
      ...
      <div className={styles.groupDiv}>
        ...
        <img className={styles.groupIcon} alt="" src="../group-542.svg" />
        <div className={styles.totalTransactionsDiv}>Total Transactions</div>
      ...
      <img className={styles.vectorIcon1} alt="" src="../vector-42.svg" />
