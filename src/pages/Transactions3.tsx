...
import styles from "./Transactions3.module.css";

const Transactions3: FunctionComponent = () => {
  const navigate = useNavigate();

  const onVuesaxbulkreceipt2IconClick = useCallback(() => {
    const anchor = document.querySelector(
      "[data-scroll-to='rectangleRectangle1']"
    );
    if (anchor) {
