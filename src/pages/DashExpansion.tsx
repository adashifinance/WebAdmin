...
import styles from "./DashExpansion.module.css";

const DashExpansion: FunctionComponent = () => {
    ...
    <div className={styles.dashExpansionDiv}>
      ...
      <div className={styles.groupDiv}>
        ...
        <img
          ...
          alt=""
          src="../vuesaxlineararrowdown8.svg"
      ...
      <div className={styles.groupDiv1}>
        ...
        <img
          ...
          alt=""
          src="../vuesaxlineararrowdown9.svg"
