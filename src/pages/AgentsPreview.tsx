...
import styles from "./AgentsPreview.module.css";

const AgentsPreview: FunctionComponent = () => {
  ...
  return (
    <div className={styles.agentsPreviewDiv}>
      ...
      <div className={styles.groupDiv19}>
        ...
        <div className={styles.groupDiv20}>
          ...
          <div className={styles.stakersWalletBalance}>
            Stakers Wallet Balance
          </div>
          <div className={styles.div32}>$23,340.00</div>
        </div>
        <img
        ...
        />
        <div className={styles.stakersDetailsDiv}>Stakers Details</div>
        <div className={styles.lineDiv10} />
        <div className={styles.maroofShittuDiv}>Maroof Shittu</div>
        <div className={styles.div33}>081374283597</div>
        <div className={styles.wuse2AgadezCrescent}>Wuse 2 Agadez crescent</div>
      ...
      <div className={styles.frameDiv4}>
        <div className={styles.groupDiv23}>
          ...
          <img
            ...
            alt=""
            src="../vuesaxbulkmoneysend35.svg"
          />
          <div className={styles.payoutDiv}>Payout</div>
          <b className={styles.b}>$21,000.50</b>
          <div className={styles.pMDiv9}>2:34PM</div>
        ...
        <div className={styles.groupDiv23}>
          ...
          <img
            className={styles.vuesaxbulkmoneySendIcon}
            alt=""
            src="../vuesaxbulkmoneyrecive.svg"
          />
          <div className={styles.payoutDiv}>Stakings</div>
          <b className={styles.b}>$21,000.50</b>
          <div className={styles.pMDiv9}>2:34PM</div>
          <div className={styles.thFeb229}>6th Feb ‘22</div>
        </div>
      ...
      <div className={styles.groupDiv31}>
        ...
        <div className={styles.groupDiv32}>
          <div className={styles.deleteDiv}>{`Suspend `}</div>
        </div>
      </div>
