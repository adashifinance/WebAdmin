...
const Savers: FunctionComponent = () => {
  ...
  return (
    <div className={styles.saversDiv}>
      ...
      />
      <div className={styles.stakersDiv}>Stakers</div>
      ...
      <div className={styles.btnDiv}>
        ...
        <b className={styles.createNewStaker}>Create New Staker</b>
      </div>
    </div>
  );
};
